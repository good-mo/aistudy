"""share300_core.config —— 全局配置与常量。

集中管理 API 地址、请求头、默认参数、沪深300 成分股列表。
"""

import os

# ── 数据源目录 ──
SHARE300_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
...
EASTMONEY_FS = "b:BK0500+f:!50"  # 沪深300 板块筛选
...
DEFAULT_TOP_N = 20            # 报告展示前 N 名
KLINE_DAYS = 120              # K 线拉取天数

# ── 成分股列表（内置兜底，运行时可 fetch_hs300_from_api 刷新）──
HS300_CODES = [
